...
from ..components import asset, twin_component, main_component, html
from ..i18n import _
...
@twin_component()
def icon(title=_("COVID-19"), subtitle=_("Epidemic Calculator"), where=None):
    st = f"""
<div id="sidebar-icon">
...
@main_component()
def footnote_disclaimer(lang="en_US", where=None, **kwargs):
    """
...
if __name__ == "__main__":
    ...
    icon("Pydemic", "Sub-title", where="sidebar")
