...
def epidemiological_params(
    ...
    Tinc = where.slider(msg, min_value=0.1, max_value=10.0, value=params.incubation_period)

    msg = _("Infectious period")
    Tinf = where.slider(msg, min_value=0.1, max_value=14.0, value=params.infectious_period)
    ...
    Th = where.slider(msg, min_value=0.1, max_value=30.0, value=params.hospitalization_period)
